...
function tipCalc(cost) {
    ...
    return: {string} 
    */
    let tip15 = `The bill was $${cost}, the tip was $${cost * 0.15}, and the total value $${cost + (cost * 0.15)}.`;
    let tip20 = `The bill was $${cost}, the tip was $${cost * 0.2}, and the total value $${cost + (cost * 0.2)}.`;
    return ((50 <= cost <= 300) ? tip15 : tip20); 
}


(function main() {
    console.log(tipCalc(275));  // tip = 41.25, totalValue = 316.25
